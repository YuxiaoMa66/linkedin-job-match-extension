# Tester Install Note — v0.3.0 branch

This preview is on `feature/v0.3.0-title-signals`. It is not merged into `main`.
...
5. Add up to five JD keywords and test `Tag`, `Bracket`, and `Spark` marker styles.
6. On a classic LinkedIn Jobs page, switch back from AI-powered search if needed, then refresh the page.
